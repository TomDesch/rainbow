...
import static io.stealingdapenta.config.PermissionNode.RAINBOW_WOLF_ARMOR;
...
/**
 * Command that gives the player a set of rainbow wolf armor pieces. Usage: /rainbowwolfitem [cycleSpeed]
 */
public class RainbowWolfItemCommand implements CommandExecutor {

    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String @NotNull [] args) {
        if (!ConfigKey.CHECK_WOLVES.asBoolean()) {
        ...
        if (!player.hasPermission(RAINBOW_WOLF_ARMOR.getNode())) {
        ...
        ItemStack armorSet = ArmorPieceFactory.ARMOR_PIECE_FACTORY.createWolfArmor(cycleSpeed);
